...
import bojkova from './images/staff/bojkova.jpg'
import helesic from './images/staff/helesic.jpg'
import omesova from './images/staff/omesova.jpg'
import sychra from './images/staff/sychra.jpg'
import zahradkova from './images/staff/zahradkova.jpg'
import paril from './images/staff/paril.jpg'
...
class Staff extends Component {
  render() {
    const staffComponents = staff.map(item => <StaffBox personInfo={item} key={item.id}/>)
    return (
      <Layout>
        <Container>{staffComponents}</Container>
      </Layout>
    )
  }
}
